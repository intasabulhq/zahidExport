    ...
    <div className="admin-shell">
      ...
      <main className="admin-products-main">
        <section className="admin-products-heading">
          <div>
            <p className="admin-kicker">Catalogue management</p>
            <h1>Products</h1>
            <p>Add, edit, publish and archive products stored in PostgreSQL.</p>
          </div>
        ...
        <section className="admin-product-toolbar" aria-label="Product filters">
          <label>
            <span>Search</span>
            <input
              value={search}
        ...
        {loading ? (
          ...
          <div className="admin-products-empty">
            ...
            <p>Create the first database-backed product.</p>
                  ...
                  <tr key={product.id}>
                    <td>
                      <div className="admin-product-identity">
                        {product.images?.[0] ? (
                          ...
                          <span className="admin-product-image-placeholder">
                            ZE
                          </span>
                        )}
                        <div>
                    ...
                    <td>
                      <select
                        ...
                        onChange={(event) =>
                          updateStatus(product, event.target.value)
                        }
                      >
